<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_admin.aspx.cs" Inherits="ecom.admin.WebForm3" %>
    ...
    <form id="form1" runat="server">
        <div class="register-card">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="a_email" runat="server" CssClass="form-control" placeholder="Enter your email"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="u_password" class="custom-label">Password:</label>
                <asp:TextBox ID="a_password" runat="server" CssClass="form-control" TextMode="Password" placeholder="Enter your password"></asp:TextBox>
            </div>
